...
[Index](-index) > [Modern d20 SRD](modern-d20-srd-index) > [Feats](modern-d20-srd-feats-index) > Aircraft Operation
...
Benefit: The character takes no penalty on [Pilot](modern-d20-srd-skills-pilot) [checks](modern-d20-srd-skills-skill-basics-php#skill-check-index) or [attack
  rolls](modern-d20-srd-combat-attack-roll) made when operating an aircraft of the selected class.

...
[Index](-index) > [Modern d20 SRD](modern-d20-srd-index) > [FX](modern-d20-srd-fx-index) > Dimension Door
...
[Level](modern-d20-srd-fx-level): [Mage](modern-d20-srd-classes-advanced-mage) 4; [Components](modern-d20-srd-fx-components): V; [Casting Time](modern-d20-srd-fx-casting-time); [Attack action](modern-d20-srd-combat-attack-actions) [Range](modern-d20-srd-fx-range): Long (400 ft. + 40 ft./level); [Target](modern-d20-srd-fx-target): You and touched objects or other touched willing creatures weighing up to 50 lb./level; [Duration](modern-d20-srd-fx-duration):  Instantaneous; [Saving Throw](modern-d20-srd-basics-saving-throws): None and Will negates (object); [Spell Resistance](modern-d20-srd-special-abilities-spell-resistance): No and Yes (object)

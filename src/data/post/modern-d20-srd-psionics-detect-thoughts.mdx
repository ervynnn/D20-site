...
[
Psionics
](modern-d20-srd-psionics-index) > Detect Thoughts
...
Display Visual, Mental; Manifestation Time: Attack action; Range: 60 ft; Area:
Quarter-circle emanating from you to the extreme of the range; Duration: Concentration,
...
prevents the manifester from reading its thoughts, and the manifester
must manifest detect thoughts again to have another chance. Creatures of animal
[
Intelligence
](modern-d20-srd-basics-ability-scores)
have
simple, instinctual thoughts that the manifester can pick up.

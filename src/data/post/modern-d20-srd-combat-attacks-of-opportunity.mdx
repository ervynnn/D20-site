...
title: Combat
excerpt: Attacks of Opportunity
tags:
  - markdown
  - conversion
  - Astro
...
[Modern d20 SRD](/#modernD20) > [Combat](modern-d20-srd-combat-index) > Attacks of Opportunity
...
An experienced character gets additional regular melee attacks (by using the full attack action), but at a lower attack bonus. A character makes his or her attack of opportunity, however, at his or her normal [attack bonus](modern-d20-srd-combat-attack-bonus)—even if the character has already attacked in this round.

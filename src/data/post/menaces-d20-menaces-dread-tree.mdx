...
[
Menaces
](menaces-d20-menaces-index) > Dread Tree
...
###
     ...
     Because a dread tree is intelligent, it gains skill points as if it were an animal. A dread tree gains a +16 species bonus on Hide checks made in forested areas.

...
Good [Saving Throws](modern-d20-srd-basics-saving-throws): Choose one (usually
Reflex).

Skill Points: 6 + [Int](modern-d20-srd-basics-ability-scores) modifier, plus 1
point per Hit Dice beyond 1 HD.
...
bonus feat selected from the following list: [Archaic Weapons Proficiency](modern-d20-srd-feats-archaic-weapons-proficiency), [Armor Proficiency (light)](modern-d20-srd-feats-armor-proficiency-light), or [Simple Weapons Proficiency](modern-d20-srd-feats-simple-weapons-proficiency).

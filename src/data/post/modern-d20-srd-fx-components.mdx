...
material components are included in the [spell descriptions](modern-d20-srd-fx-spell-descriptions); if no value is given, assume a purchase DC of 2.
...
Sometimes the Components entry of a [spell description](modern-d20-srd-fx-spell-descriptions) contains the entry “M/DF”. This indicates a spell that can
be cast as either an arcane spell or a divine spell—an arcane caster casting
it needs the specified material component, while a divine caster needs to
provide a divine focus.

...
[
Creatures
](arcana-d20-srd-creatures-index) > Otyugh
...
###
     ...
     Improved Grab (Ex): To use this ability, the otyugh must hit an opponent at least one size category smaller than itself with a tentacle attack. If it gets a

hold, it can constrict (see below).

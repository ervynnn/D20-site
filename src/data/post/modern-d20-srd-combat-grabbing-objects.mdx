...
[Modern d20 SRD](/#modernD20) > [Combat](modern-d20-srd-combat-index) > Grabbing Objects
...
snatch away an object worn by a target. Doing this works the same as a
[disarm](modern-d20-srd-combat-disarm)
attempt,
...
, the attempt to grab the object automatically fails.
     ...
     Failed Attempts: Failing an attempt to grab an object doesn’t allow the target to attempt to
     [disarm](modern-d20-srd-combat-disarm)
     the character.

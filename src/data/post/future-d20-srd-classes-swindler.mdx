...
[Index](-index) > [Future d20 SRD](future-d20-srd-index) > [Classes](future-d20-srd-classes-index) > Swindler
...
Action Points
The Swindler gains a number of action points equal to 7 + one-half his character level, rounded down, every time he
attains a new level in this class. (The Swindlers ability to manipulate probability entitles him to a higher number of action points per class level than other advanced classes.)

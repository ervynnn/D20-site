...
2; [Components](modern-d20-srd-fx-components): V, S, M; [Casting Time](modern-d20-srd-fx-casting-time); [Attack action](modern-d20-srd-combat-attack-actions) [Range](modern-d20-srd-fx-range): Personal or touch;
...
negates (harmless) or Will negates (harmless, object); [Spell Resistance](modern-d20-srd-special-abilities-spell-resistance): Yes (harmless)

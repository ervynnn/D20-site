...
## Handle Animal ([Cha](modern-d20-srd-basics-ability-scores)) [Trained Only](modern-d20-srd-skills-skill-basics-php#skill-check-index)

[Check](modern-d20-srd-skills-skill-basics-php#skill-check-index): The time
required to get an effect and the DC depend on what the character is trying to
do.
...
If the [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) is
...
[check](modern-d20-srd-skills-skill-basics-php#skill-check-index) is
successful, the animal performs the task or trick on its next action.
...
Animal [check](modern-d20-srd-skills-skill-basics-php#skill-check-index). An
animal with an [Intelligence](modern-d20-srd-basics-ability-scores) of 1 can
learn a maximum of three tricks, while an animal with an
...
his or her Handle Animal [check](modern-d20-srd-skills-skill-basics-php#skill-check-index). Teaching an animal to obey only the character counts as a trick
(in terms of how many tricks the animal can learn). It does not require a
[check](modern-d20-srd-skills-skill-basics-php#skill-check-index); however, it
increases the DC of all tricks the character teaches the animal by +5. If the
animal already knows any tricks, the character cannot teach it to obey only
that character.
...
animal to [attack](modern-d20-srd-combat-attack-roll) that enemy. Normally, an
animal only [attacks](modern-d20-srd-combat-attack-roll) humans and other
animals. Teaching an animal to [attack](modern-d20-srd-combat-attack-roll) all
creatures (including unnatural creatures such as undead and aberrations if
...
weeks and making a Handle Animal [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) (DC 20). If the animal was trained in other tricks (in
addition to those provided by training the animal for riding), those tricks
...
An untrained character uses [Charisma checks](modern-d20-srd-skills-skill-basics) to handle and push animals, but he or she can’t teach or train
animals.

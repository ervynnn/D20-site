...
[Modern d20 SRD](/#modernD20) > [FX](modern-d20-srd-fx-index) > Duration
...
Concentration: The spell or power lasts as long as the caster concentrates on it, possibly up to a specified maximum amount of time. Concentrating to maintain a spell is an [attack action](modern-d20-srd-combat-attack-actions) that does not provoke [attacks of opportunity](modern-d20-srd-combat-attacks-of-opportunity). Anything that could break the character’s concentration when
...
(D): If the Duration entry ends with “(D)” (standing for “dismissible”), the caster can dismiss the spell at will. The caster must be within range of the effect of the spell to dismiss it. Dismissing a spell is an [attack action](modern-d20-srd-combat-attack-actions) that does not provoke [attacks of opportunity](modern-d20-srd-combat-attacks-of-opportunity). A spell that depends on concentration is dismissible by its very nature, and dismissing it does not require an action (since all the caster has to do to end the spell is to stop concentrating).

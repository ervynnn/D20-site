...
To attack with a splash weapon, make a [ ranged touch attack ](modern-d20-srd-combat-attack-actions) against the target. Thrown weapons require no weapon
proficiency, so characters don’t take the –4 nonproficient penalty. A hit
deals direct hit [ damage ](modern-d20-srd-combat-damage) to the target and
splash [ damage ](modern-d20-srd-combat-damage) to all other creatures within

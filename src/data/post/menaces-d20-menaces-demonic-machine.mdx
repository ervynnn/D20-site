...
[
Menaces
](menaces-d20-menaces-index) > Demonic Machine
...
###
     ...
     Though technically a construct, a demonic machine is animated by a fell presence from beyond Shadow. It gains feats as an outsider (1, plus 1 feat per 4 HD beyond 1 HD).
     ...
     A demonic machine gains skills as if it were an outsider (8 + Int modifier per HD).
     ...
     Bluff +5, Listen +10, Sense Motive +8, Spot +10.

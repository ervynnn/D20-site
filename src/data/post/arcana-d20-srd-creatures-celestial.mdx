...
[
Creatures
](arcana-d20-srd-creatures-index) > Celestial
...
###
     ...
     Immunities (Ex): A celestial is immune to one or more specific types of energy or weapon damage, as determined by rolling on Table: Celectial Immunities,

Resistances, and Damage Reduction.

     Energy Resistance (Ex): A celestial is resistant to one or more types of energy, as determined by rolling on Table: Celectial Immunities, Resistances, and

Damage Reduction. Roll again if the celestial is resistant to a type of energy against which it already has immunity.

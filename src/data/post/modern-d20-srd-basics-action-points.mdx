...
[Index](-index) > [Modern d20 SRD](modern-d20-srd-index) > [Basics](modern-d20-srd-basics-index) > Action Points
...
Alter a single d20 roll used to make an attack, a [skill
    check](modern-d20-srd-skills-skill-basics-php#skill-check-index), an [ability
  check](modern-d20-srd-basics-ability-scores), a level check, or a [saving

...
[Modern d20 SRD](/#modernD20) > [Basics](modern-d20-srd-basics-index) > Action Points
...
Alter a single d20 roll used to make an attack, a [skill check](modern-d20-srd-skills-skill-basics-php#skill-check-index), an [ability check](modern-d20-srd-basics-ability-scores), a level check, or a [saving throw](modern-d20-srd-basics-saving-throws).

Use a class talent or class feature during your turn for which the expenditure of 1 action point is required.

When a character spends 1 action point to improve a d20 roll, add 1d6 to the d20 roll to help meet or exceed the target number. A character can declare the use of 1 action point to alter a d20 roll after the roll is made—but
only before the GM reveals the result of that roll (whether the attack or check
or saving throw succeeded or failed). A character can’t use an action point on a skill check or ability check when he or she is taking 10 or taking 20.

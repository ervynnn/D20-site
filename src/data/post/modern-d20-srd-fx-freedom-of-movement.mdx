...
[ Level ](modern-d20-srd-fx-level) : [ Acolyte ](modern-d20-srd-classes-advanced-acolyte) 4; [ Components ](modern-d20-srd-fx-components) : V, S, M,
DF; [ Casting Time ](modern-d20-srd-fx-casting-time) ; [ Attack action](modern-d20-srd-combat-attack-actions) [ Range ](modern-d20-srd-fx-range) :
Personal or touch; [ Target ](modern-d20-srd-fx-target) : You or creature
touched; [ Duration ](modern-d20-srd-fx-duration) : 10 minutes/_level; [Saving Throw ](modern-d20-srd-basics-saving-throws) : Will negates (harmless);

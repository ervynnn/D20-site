...
3; [Components](modern-d20-srd-fx-components): V, S, M; [Casting Time](modern-d20-srd-fx-casting-time); [Attack action](modern-d20-srd-combat-attack-actions) [Range](modern-d20-srd-fx-range): Personal or touch;
...
or Will negates (harmless, object); [Spell Resistance](modern-d20-srd-special-abilities-spell-resistance): Yes (harmless) or Yes (harmless, object)
...
[checks](modern-d20-srd-skills-skill-basics-php#skill-check-index) if
immobile, or a +20 bonus on [Hide](modern-d20-srd-skills-hide)
[checks](modern-d20-srd-skills-skill-basics-php#skill-check-index) if moving.
Pinpointing the location of an invisible character who isn’t attempting to
hide requires a [Spot](modern-d20-srd-skills-spot) [check](modern-d20-srd-skills-spot-php#skill-check-index) against DC 40 if immobile or DC 20 if
moving.

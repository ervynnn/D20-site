...
[Index](-index) > [Modern d20 SRD](modern-d20-srd-index) > [FX](modern-d20-srd-fx-index) > Magic Mouth
...
[Level](modern-d20-srd-fx-level): [Mage](modern-d20-srd-classes-advanced-mage) 2; [Components](modern-d20-srd-fx-components): V, S, M; [Casting Time](modern-d20-srd-fx-casting-time); [Attack action](modern-d20-srd-combat-attack-actions) [Range](modern-d20-srd-fx-range): Close (25 ft. + 5 ft./2 levels); [Target](modern-d20-srd-fx-target): One creature or object; [Duration](modern-d20-srd-fx-duration):  Permanent until discharged; [Saving Throw](modern-d20-srd-basics-saving-throws): Will negates (object); [Spell Resistance](modern-d20-srd-special-abilities-spell-resistance): Yes (object)

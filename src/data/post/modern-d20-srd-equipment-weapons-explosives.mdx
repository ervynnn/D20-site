...
radius; each additional block increases the [damage](modern-d20-srd-combat-damage) by +2d6 and the burst radius by 2 feet, and requires a
[Demolitions](modern-d20-srd-skills-demolitions) [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) (DC 15) to link them.
...
explosive for the purpose of using a [Craft (chemical)](modern-d20-srd-skills-craft-chemical) [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) to manufacture it.
...
explosive effect. Doing so requires a [Demolitions](modern-d20-srd-skills-demolitions) [check](modern-d20-srd-skills-skill-basics-php#skill-check-index)

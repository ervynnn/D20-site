...
4; [Components](modern-d20-srd-fx-components): V, S, M; [Casting Time](modern-d20-srd-fx-casting-time): 10 minutes; [Range](modern-d20-srd-fx-range): Touch; [Target](modern-d20-srd-fx-target): Object touched;
[Duration](modern-d20-srd-fx-duration): Permanent until discharged (D);
[Saving Throw](modern-d20-srd-basics-saving-throws): Reflex half (see text);
...
A successful [Search](modern-d20-srd-skills-search) [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) (DC 29) finds an energy trap, and a
successful [Disable Device](modern-d20-srd-skills-disable-device)
[check](modern-d20-srd-skills-skill-basics-php#skill-check-index) (DC 29)
safely removes it.

...
bonus to certain [ Charisma ](modern-d20-srd-basics-ability-scores) -based [skill checks ](modern-d20-srd-skills-skill-basics-php#skill-check-index) .
...
Infamy, when recognized, provides a penalty to certain [ Charisma](modern-d20-srd-basics-ability-scores) -based [ skill checks](modern-d20-srd-skills-skill-basics-php#skill-check-index) .

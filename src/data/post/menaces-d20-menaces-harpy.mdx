...
[
Menaces
](menaces-d20-menaces-index) > Harpy
...
###
     ...
     Bluff +6, Listen +5, Perform (act) +8, Perform (sing) +8, Perform (stand-up) +6, Read/Write English, Speak English, Spot +6.
     ...
     Flyby Attack, Personal Weapon Proficiency, Simple Weapons Proficiency.

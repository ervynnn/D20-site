...
Special: A character without a [mechanical tool kit](modern-d20-srd-equipment-professional-equipment) takes a –4 penalty on Craft (structural)
...
bonus on all Craft (structural) [checks](modern-d20-srd-skills-skill-basics-php#skill-check-index).

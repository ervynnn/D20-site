...
[Index](-index) > [Future d20 SRD](future-d20-srd-index) > [Starships](future-d20-srd-starships-index) > [Starship Engines](future-d20-srd-starships-starship-engines-index) > Photon Sails
...
In combat, any weapon hit against a sail-driven starship destroys the deployed photon sails and prevents the ship from moving until
the sails are replaced. The sail-ship continues on its last course and retains its former speed until the sails are replaced. Accordingly,
most sail-ships carry a secondary propulsion system (such as thrusters or an ion engine) for emergency maneuvering and sailing against
the sun. Photon sails are completely useless in atmospherein fact, theyre instantly destroyed by atmospheric entrymaking a secondary

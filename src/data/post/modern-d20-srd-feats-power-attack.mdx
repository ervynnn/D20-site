...
choose to subtract a number from all melee [attack rolls](modern-d20-srd-combat-attack-roll) and add the same number to all melee [damage rolls](modern-d20-srd-combat-damage). This number may not exceed the

...
title: Updated MDX File
excerpt: Auto-converted HTML to MDX with revised instructions.
tags:
  - markdown
  - conversion
  - Astro
...
[Modern d20 SRD](modern-d20-srd-index) > Bookmarks

## Navigating d20resources.com with Downloadable Bookmarks

d20resources.com was designed to be a simple, fast, and easy-to-use d20 HTML resource. Due to the vast amount of data available, traditional website navigation can be challenging. To address this, we provide:
...
- [Click here](modern.d20.srd.html) to download the d20resources.com Bookmarks file.

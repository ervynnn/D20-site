...
[move](modern-d20-srd-combat-move-actions) or [attack action](modern-d20-srd-combat-attack-actions) to note the direction of the scent. If it moves within
5 feet of the source, the creature can pinpoint that source.
...
ability otherwise follows the rules for the [Track](modern-d20-srd-feats-track) feat. Creatures tracking by scent ignore the effects of surface

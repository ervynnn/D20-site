...
[
Menaces
](menaces-d20-menaces-index) > Etoile
...
###
     ...
     Computer Use +13, Craft (electrical) +13, Craft (mechanical) +13, Demolitions +9, Disable Device +13, Knowledge (technology) +11; Repair +13, Treat Injury +7.
     ...
     Builder, Cautious, Gearhead, Surgery, Weapon Finesse (pincer).

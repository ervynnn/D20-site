...
which are all in the turret.) It takes a [full-round](modern-d20-srd-combat-full-round-actions) action to enter a tank and another [full-round action](modern-d20-srd-combat-full-round-actions) to start it moving. The
Abrams is three squares wide and six squares long. It provides full
...
disembark. It takes a [full-round action](modern-d20-srd-combat-full-round-actions) to enter the vehicle through a top hatch, and another [full-round action](modern-d20-srd-combat-full-round-actions) to start it moving. In
...
position as well as a rear door. It takes a [full-round action](modern-d20-srd-combat-full-round-actions) to enter the vehicle through
a top hatch and another [full-round action](modern-d20-srd-combat-full-round-actions) to start it moving. The Gavin is three squares wide and four squares
long. It provides full [cover](modern-d20-srd-combat-cover) to its occupants.

...
[Modern d20 SRD](/#modernD20) > [Skills](modern-d20-srd-skills-index) > Skill Basics

## Skill Basics

Getting Skills

At each level, a character gets skill points that are used to buy skills. The characters class and [Intelligence](modern-d20-srd-basics-ability-scores) modifier determine the number of points received.
...
Miscellaneous Modifiers: Miscellaneous modifiers include bonuses provided by [feats](modern-d20-srd-feats-index) and class features, and penalties such as the ones associated with the nonproficient use of armor, among others.
...
| :---------------------------------------- | -----------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|                                           |                                                                                                                                                                          |
| Very easy (0)                             |                                                                                               Notice something large in plain sight ([Spot](modern-d20-srd-skills-spot)) |
| Easy (5)                                  |                                                                                                              Climb a knotted rope ([Climb](modern-d20-srd-skills-climb)) |
| Average (10)                              |                                                                                              Hear an approaching security guard ([Listen](modern-d20-srd-skills-listen)) |
| Tough (15)                                |                                                                                                   Disarm an explosive ([Demolitions](modern-d20-srd-skills-demolitions)) |
| Challenging (20)                          |                                                                                                       Swim against a strong current ([Swim](modern-d20-srd-skills-swim)) |
| Formidable (25)                           |                                                                                                                           Break into a secure computer system ([Computer | | Use](modern-d20-srd-skills-computer-use)) |
| Heroic (30)                               |                                                                                                         Leap across a 30-foot chasm ([Jump](modern-d20-srd-skills-jump)) |
| Superheroic (35)                          | Convince the guards that even though youre not wearing an ID badge and arent on their list, they should let you into the building ([Bluff](modern-d20-srd-skills-bluff)) |
| Nearly impossible (40)                    |                        Track a trained commando through the forests of Brazil on a moonless night after 12 days of rainfall ([Survival](modern-d20-srd-skills-survival)) |
...
| :------------------------------- | :------------------------------------------------------: | -------------------------------------------------: |
|                                  |                                                          |                                                    |
| Sneak up on someone              |   [Move Silently](modern-d20-srd-skills-move-silently)   |                                            [Listen | | ](modern-d20-srd-skills-listen)  |
| Con someone                      |           [Bluff](modern-d20-srd-skills-bluff)           | [Sense Motive](modern-d20-srd-skills-sense-motive) |
| Hide from someone                |            [Hide](modern-d20-srd-skills-hide)            |                                              [Spot | | ](modern-d20-srd-skills-spot)    |
| Win a car race                   |           [Drive](modern-d20-srd-skills-drive)           |               [Drive](modern-d20-srd-skills-drive) |
| Pretend to be someone else       |        [Disguise](modern-d20-srd-skills-disguise)        |                                              [Spot | | ](modern-d20-srd-skills-spot)    |
| Steal a key chain                | [Sleight of Hand](modern-d20-srd-skills-sleight-of-hand) |                                              [Spot | | ](modern-d20-srd-skills-spot)    |
| Create a fake ID                 |         [Forgery](modern-d20-srd-skills-forgery)         |                                           [Forgery | | ](modern-d20-srd-skills-forgery) |
...
3. Reduce the DC by 2 to represent circumstances that make the task easier, such as having a friendly audience when making a [Perform](modern-d20-srd-skills-perform) check or searching for information on an extremely well documented topic with a [Computer    Use](modern-d20-srd-skills-computer-use) check.

4. Increase the DC by 2 to represent circumstances that make the task harder, such as making a [Perform](modern-d20-srd-skills-perform) check in front of a hostile audience or searching for information on a very poorly documented topic with a [Computer    Use](modern-d20-srd-skills-computer-use) check.
...
Using a skill might take a round, several rounds, or even longer. It might take
no time at all. Types of actions define how long activities take to perform
within the framework of a combat round (6 seconds) and how movement is treated
with respect to the activity. See the skill description for specifies on how
long a skill takes to use. In general, using a skill that requires concentration
while in close combat is dangerous. Nearby opponents can make [attacks of opportunity](modern-d20-srd-combat-attacks-of-opportunity) against a character when he or she lets his or her guard down.
...
Circumstance bonuses stack only if theyre provided by differing circumstances; if two circumstance bonuses caused by similar circumstances apply, they dont stack.

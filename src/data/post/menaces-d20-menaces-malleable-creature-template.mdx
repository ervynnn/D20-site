...
[
Menaces
](menaces-d20-menaces-index) > Malleable Creature (Template)
...
###
    ...
    Bluff +8, Climb +3, Concentration +6, Disguise +13, Escape Artist +14, Knowledge (current events) +2, Read/ Write English, Speak English, Spot +7, Survival +7.
    ...
    Armor Proficiency (light), Combat Martial Arts, Defensive Martial Arts, Great Fortitude, Improved Combat Martial Arts, Nimble, Simple Weapons Proficiency, Toughness.

...
[skill](modern-d20-srd-skills-index) for the character, he or she also gains a
one-time competence bonus for that [skill](modern-d20-srd-skills-index).

Some starting occupations provide a [Reputation](modern-d20-srd-reputation-index) bonus or a bonus [feat](modern-d20-srd-feats-index) (in addition to the
two [feats](modern-d20-srd-feats-index) a 1st-level character already
receives). A character still must meet any prerequisites for these bonus

...
[Modern d20 SRD](/#modernD20) > [Combat](modern-d20-srd-combat-index) > Move Actions
...
Standing up from a prone position requires a move action. It provokes an [attack of opportunity](modern-d20-srd-combat-attacks-of-opportunity) from opponents who threaten the character.

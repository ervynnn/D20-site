...
[check](modern-d20-srd-skills-skill-basics-php#skill-check-index), the result
of which determines the quality of the work.

No [Wealth check](modern-d20-srd-wealth-wealth-check) is necessary to use this
Craft skill.
...
gets a +2 bonus on all Craft (writing) [checks](modern-d20-srd-skills-skill-basics-php#skill-check-index).

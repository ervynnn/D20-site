...
The Craft (pharmaceutical) [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) is based on the severity of the
[disease](modern-d20-srd-environment-hazards-disease) to be countered as
measured by the DC of the [Fortitude save](modern-d20-srd-basics-saving-throws) needed to resist it.
...
Special: A character without a [pharmacist kit](modern-d20-srd-equipment-professional-equipment) takes a –4 penalty on Craft (pharmaceutical)
...
feat gets a +2 bonus on all Craft (pharmaceutical) [checks](modern-d20-srd-skills-skill-basics-php#skill-check-index).

...
weapon harder and faster, so a character’s [Strength](modern-d20-srd-basics-ability-scores) modifier applies to [melee attack](modern-d20-srd-combat-attack-roll) rolls.
...
steadiness, so a character’s [Dexterity](modern-d20-srd-basics-ability-scores)
...
using and how far away the target is. All ranged [weapons](modern-d20-srd-equipment-equipment-weapons) and thrown [weapons](modern-d20-srd-equipment-equipment-weapons) have a range increment. Any attack from a distance of less
than one range increment is not penalized for range. However, each full range
increment causes a cumulative –2 penalty on the [attack roll](modern-d20-srd-combat-attack-roll). A thrown weapon has a maximum range of five range
increments. Ranged weapons that fire projectiles can shoot up to ten
increments.

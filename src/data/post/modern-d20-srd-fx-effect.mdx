...
[ Modern d20 SRD ](/#modernD20) > [ FX](modern-d20-srd-fx-index) > Effect
...
though typically the character makes a ranged [ touch attack ](modern-d20-srd-combat-attack-roll) rather than a [ normal ranged attack ](modern-d20-srd-combat-attack-roll) . As with a ranged weapon, the character can fire into the
dark or at an invisible creature and hope to hit something. A character
doesn’t have to see the creature he or she is trying to hit, as with a
targeted spell. Intervening creatures and obstacles, however, can block the
caster’s line of sight or provide [ cover ](modern-d20-srd-combat-cover) for
the creature being aimed at.

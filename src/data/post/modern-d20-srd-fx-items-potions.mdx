...
[Modern d20 SRD](/#modernD20) > [FX Items](modern-d20-srd-fx-items-index) > Potions

## Potions

A potion is an elixir concocted with a [spell](modern-d20-srd-fx-index)-like
or [psionic](modern-d20-srd-psionics-index) effect that affects only the
drinker. A potion is a single-use item that can only duplicate
[spells](modern-d20-srd-fx-index) or [psionic powers](modern-d20-srd-psionics-index) of 3rd level or lower. A potion vial has a Defense of 12, hardness 1, 1
hit point, and a break DC of 12. A vial holds 1 ounce of liquid.

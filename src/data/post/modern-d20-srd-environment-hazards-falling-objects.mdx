...
beyond the first (to a maximum of 20d6 points of [ damage ](modern-d20-srd-combat-damage) ). Objects of Fine size are too small to deal [ damage](modern-d20-srd-combat-damage) , regardless of the distance fallen.

A successful [ Reflex save ](modern-d20-srd-basics-saving-throws) indicates
that the target takes half [ damage ](modern-d20-srd-combat-damage) . The size
of the falling object determines the [ save ](modern-d20-srd-basics-saving-throws) DC.
...
object off him or herself or an [ Escape Artist ](modern-d20-srd-skills-escape-artist) [ check ](modern-d20-srd-skills-skill-basics-php#skill-check-index) (DC 20) to get out from underneath. The GM can modify the DCs for these

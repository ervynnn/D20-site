...
[
Creatures
](arcana-d20-srd-creatures-index) > Gremlin
...
###
     ...
     Mystic Aid (Su): When a gremlin aids another gremlin with a Disable Device check, the aid another attempt succeeds automatically, granting a +2 bonus to the

check. The gremlin providing the aid must be adjacent to the gremlin performing the check.

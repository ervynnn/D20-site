...
(covered by the [Simple Weapons Proficiency](modern-d20-srd-feats-simple-weapons-proficiency) feat); others are archaic ([Archaic Weapons Proficiency](modern-d20-srd-feats-archaic-weapons-proficiency)) or exotic
...
confirmed, a weapon deals double damage on a [critical hit](modern-d20-srd-combat-critical-hits) (roll damage twice, as if hitting the target two times).

Damage Type: Melee weapon [damage](modern-d20-srd-combat-damage) is classified
according to type: bludgeoning (weapons with a blunt striking surface), energy
(of a specific type), piercing (weapons with a sharp point), and slashing
(weapons with an edged blade). Some creatures or characters may be resistant

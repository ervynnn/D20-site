...
[Future d20 SRD](/#futureD20) > [Equipment](future-d20-srd-equipment-index) > Gravity Age Weapons
...
## Progress Level 7 Ranged Weapons

| Weapon            | Damage    | Critical | Damage Type | Range Increment | RoF  | Magazine | Size  | Weight | Purchase DC | Restriction |
| :---------------- | :------:  | :-----:  | :---------: | :-------------: | :--: | :-----:  | :---: | :----: | ----------: | :---------: |
...
## Progress Level 7 Melee Weapons

| *All weapons listed in this table require the Simple Weapons Proficiency feat.* |

## Progress Level 7 Ammunition Types

| Ammunition Type        | Damage Type       | Purchase DC | Restriction |
| :--------------------: | :--------------:  | ----------: | :--------: |
| Deflecting (20)        | Ballistic         | 12          | Lic (+1)   |
| Plasma-coated (20)     | Ballistic/Fire    | 13          | Res (+2)   |
| Rail gun shards (20)   | Ballistic         | 10          | —          |
| Seeker (20)            | Ballistic         | 15          | Res (+2)   | Ballistic         | 15          | Res (+2)   |

## Progress Level 7 Explosives And Splash Weapons

| Weapon            | Damage    | Critical | Damage Type | Burst Radius | Ref Save DC | Range Increment | Size  | Weight | Purchase DC | Restriction |
| :---------------- | :------:  | :-----:  | :---------: | :----------: | :--------:  | :-------------: | :---: | :----: | ----------: | :---------: |

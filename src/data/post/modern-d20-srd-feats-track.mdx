...
[Survival](modern-d20-srd-skills-survival) [check](modern-d20-srd-skills-skill-basics-php#skill-check-index). The character must make another
[Survival](modern-d20-srd-skills-survival) [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) every time the tracks become difficult to
follow.

The character moves at half his or her normal speed (or at the character’s
normal speed with a –5 penalty on the [check](modern-d20-srd-skills-skill-basics-php#skill-check-index), or at up to twice the character’s speed with a
–20 penalty on the check). The DC depends on the surface and the prevailing
conditions.
...
can retry after 1 hour (out­doors) or 10 minutes (indoors) of searching.

Normal: A character without this feat can use the [Survival](modern-d20-srd-skills-survival) skill to find tracks, but can only follow tracks if the DC is
10 or less. A character can use the [Search](modern-d20-srd-skills-search)
skill to find individual footprints, but cannot follow tracks using

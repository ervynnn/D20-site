...
bonus for the character’s [starting occupation](modern-d20-srd-starting-occupation-index), plus (if appropriate) the bonus from the
[Windfall](modern-d20-srd-feats-windfall) feat, plus 1 if the character has
ranks in [Profession](modern-d20-srd-skills-profession).

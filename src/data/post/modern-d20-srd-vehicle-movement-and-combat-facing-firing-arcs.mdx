...
Unlike with characters, when dealing with [vehicles](modern-d20-srd-equipment-equipment-vehicles), the [vehicle’s](modern-d20-srd-equipment-equipment-vehicles) facing (the direction it’s pointing) is important. Facing indicates
the direction in which the [vehicle](modern-d20-srd-equipment-equipment-vehicles) is traveling (assuming it’s not moving in reverse). It can also
determine which weapons aboard the vehicle can be brought to bear on a target.

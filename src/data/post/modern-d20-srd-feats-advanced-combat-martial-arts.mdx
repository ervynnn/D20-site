...
Benefit: When the character scores a [ critical hit ](modern-d20-srd-combat-critical-hits) on an opponent with an unarmed strike, the character deals
triple [ damage ](modern-d20-srd-combat-damage) .

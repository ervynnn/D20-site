...
gets a saving throw to avoid or reduce the effect. Like an [attack roll](modern-d20-srd-combat-attack-roll), a saving throw is a 1d20 roll plus a
bonus based on the hero’s class and level (the hero’s base save bonus) and an
...
poison and paralysis. Apply the character’s [Constitution](modern-d20-srd-basics-ability-scores) modifier to his or her Fortitude saving throws.

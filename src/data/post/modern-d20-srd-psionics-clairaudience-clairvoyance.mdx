...
title:  Psionics
excerpt: Clairaudience/Clairvoyance
tags:
  - markdown
  - conversion
  - Astro
...
[ Modern d20 SRD ](/#modernD20) > [ Psionics](modern-d20-srd-psionics-index) > Clairaudience/Clairvoyance
...
Visual, Audible; Manifestation Time: [ Attack action ](modern-d20-srd-combat-attack-actions) ; Range: See text; Duration: 1 minute/level (D); Saving Throw:

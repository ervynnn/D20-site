...
[Index](-index) > [Modern d20 SRD](modern-d20-srd-index) > [Equipment](modern-d20-srd-equipment-index) > [Weapons](modern-d20-srd-equipment-equipment-weapons) > Longarms 
...
All longarms are covered by the [Personal
Firearms Proficiency](modern-d20-srd-feats-personal-firearms-proficiency) feat.



Longarms are not well suited to close combat. A character takes a 4 penalty on the [attack
roll](modern-d20-srd-combat-attack-roll) when firing at an adjacent target.
...
Due to its high quality of manufacture, the MP5 is always considered a [mastercraft](modern-d20-srd-equipment-mastercraft-objects) weapon. As such, it grants a +1 bonus on [attack

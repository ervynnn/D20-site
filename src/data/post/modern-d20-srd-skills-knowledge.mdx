...
[Modern d20 SRD](/#modernD20) > [Skills](modern-d20-srd-skills-index) > Knowledge
...
[Check](modern-d20-srd-skills-skill-basics-php#skill-check-index): A character makes a Knowledge [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) to see if the character knows something.
...
Try Again?: No. The [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) represents what a character knows, and thinking about a topic a second time doesn’t let the character know something he or she never knew in the first place.

Special: An untrained Knowledge [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) is simply an [Intelligence check](modern-d20-srd-skills-skill-basics). Without actual training, a character only knows common knowledge about a given subject.

A character can [take 10](modern-d20-srd-skills-skill-basics-php#take10-index) when making a Knowledge [check](modern-d20-srd-skills-skill-basics-php#skill-check-index), but can’t take 20.

A character with the [Educated](modern-d20-srd-feats-educated) feat gets a +2 bonus on any two types of Knowledge [checks](modern-d20-srd-skills-skill-basics-php#skill-check-index).

The GM may decide that having 5 or more ranks in a specific Knowledge skill provides a character with a +2 [synergy bonus](modern-d20-srd-skills-skill-basics-php#skill-synergy-index) when making a related [skill check](modern-d20-srd-skills-skill-basics-php#skill-check-index).

Time: A Knowledge [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) can be a reaction, but otherwise requires a [full-round action](modern-d20-srd-combat-full-round-actions).

...
[Index](-index) > [Modern d20 SRD](modern-d20-srd-index) > [Skills](modern-d20-srd-skills-index) > Knowledge
...
Special: An untrained Knowledge [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) is simply an [Intelligence
check](modern-d20-srd-skills-skill-basics). Without actual training, a character only knows common knowledge about a given subject.



A character can [take
10](modern-d20-srd-skills-skill-basics-php#take10-index) when making a Knowledge [check](modern-d20-srd-skills-skill-basics-php#skill-check-index), but cant take 20.
...
The GM may decide that having 5 or more ranks in a specific Knowledge skill provides a character with a +2 [synergy
bonus](modern-d20-srd-skills-skill-basics-php#skill-synergy-index) when making a related [skill
check](modern-d20-srd-skills-skill-basics-php#skill-check-index).



Time: A Knowledge [check](modern-d20-srd-skills-skill-basics-php#skill-check-index) can be a reaction, but otherwise requires a [full-round

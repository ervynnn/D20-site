...
[Modern d20 SRD](/#modernD20) > [Classes](modern-d20-srd-classes-index) > Multiclass Characters
...
###
     ...
     [basic  class](modern-d20-srd-classes-basic-index)
or, if the character qualifies for it, an
[advanced class](modern-d20-srd-classes-advanced-index)
.

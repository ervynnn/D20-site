...
Add [ Reputation ](modern-d20-srd-reputation-index) bonuses together.
...
The character gets all class features (talents, bonus [ feats](modern-d20-srd-feats-index) , or other special abilities) of all classes for
the levels he or she possesses.
...
A multiclass character increases one [ ability score ](modern-d20-srd-basics-ability-scores) by +1 every four character levels, regardless of individual
class level.
...
level. This could be a [ basic class ](modern-d20-srd-classes-basic-index) or,
if the character qualifies for it, an [ advanced class ](modern-d20-srd-classes-advanced-index) .

The character gains the 1st-level base attack bonus, base save bonuses, class
skills, other class features of the new class, [ hit points ](modern-d20-srd-combat-hit-points) of the appropriate die type, and the new class’s number of
skill points gained at each additional level (not that number x4, as is the
...
attaining the new level in that class: more [ hit points ](modern-d20-srd-combat-hit-points) , possible bonuses on [ attack rolls ](modern-d20-srd-combat-attack-roll) , [ Defense ](modern-d20-srd-combat-defense) , and [saving throws ](modern-d20-srd-basics-saving-throws) (depending on the class
and the new level), a new class feature (as defined by the class), and new
skill points.

[ Skill ](modern-d20-srd-skills-index) points are spent according to the class
that the multiclass character just advanced in. [ Skills ](modern-d20-srd-skills-index) are purchased at the cost appropriate for that class.

...
his or her [ Constitution ](modern-d20-srd-basics-ability-scores) score. After
this, the character must make a [ Constitution ](modern-d20-srd-basics-ability-scores) check each hour (DC 10, +1 for each previous check) or take
1d6 points of [ damage ](modern-d20-srd-combat-damage) .

A character can go without food for three days, in growing discomfort. After
this, the character must make a [ Constitution ](modern-d20-srd-basics-ability-scores) check each day (DC 10, +1 for each previous check) or sustain
1d6 points of [ damage ](modern-d20-srd-combat-damage) .

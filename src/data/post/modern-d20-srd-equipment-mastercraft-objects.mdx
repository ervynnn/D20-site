...
[Weapons](modern-d20-srd-equipment-equipment-weapons), [armor](modern-d20-srd-equipment-armor-general), and some other types of equipment can be constructed as mastercraft objects. The exceptional quality of these objects provides the user a bonus on [attack rolls](modern-d20-srd-combat-attack-roll), [damage](modern-d20-srd-combat-damage), [Defense](modern-d20-srd-combat-defense), or some other characteristic that improves when the object is used.

...
[
Creatures
](arcana-d20-srd-creatures-index) > Big Cat
...
###
     ...
     Rake (Ex): If a big cat successfully grabs its prey (see Improved Grab, above), it can make two rake attacks (+6 melee) with its hind legs as part of a full

attack. Each successful rake attack deals 1d3+1 points of damage.

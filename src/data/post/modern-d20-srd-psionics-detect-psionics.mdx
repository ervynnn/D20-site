...
Level: Telepath 0/ [ Battle Mind ](modern-d20-srd-classes-advanced-battle-mind) 0; Display: Visual, Audible; Manifestation Time: [ Attack action](modern-d20-srd-combat-attack-actions) ; Range: 60 ft.; Area: Quarter-circle
emanating from you to the extreme of the range; Duration: Concentration, up to
1 minute/level (D); [ Saving Throw ](modern-d20-srd-basics-saving-throws) :

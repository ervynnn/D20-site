...
that deals 4d8 points of [ damage ](modern-d20-srd-combat-damage) +1 point per
caster level (maximum +10).

Since [ undead ](modern-d20-srd-creature-types-undead) are powered by negative
energy, this spell cures them of a like amount of [ damage ](modern-d20-srd-combat-damage) rather than harming them.

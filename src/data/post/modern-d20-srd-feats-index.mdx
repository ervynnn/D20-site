...
Prerequisite: A minimum [ability score](modern-d20-srd-basics-ability-scores),
another feat or feats, a minimum base attack bonus, and/or the minimum ranks
in a skill that a character must have to acquire this feat. This entry is
absent if a feat has no prerequisite.
